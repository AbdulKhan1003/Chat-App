...
const MessageInput = () => {
  ...
  const handleImageChange = (e) => {
    ...
    const maxSizeInBytes = 0.05 * 1024 * 1024;
    ...
    <div className='p-4 w-full'>
      ...
      <form onSubmit={handleSendMessage} className='flex gap-2 items-center'>
        <div className="flex-1 flex gap-2">
          ...
          {/* wese to input hidden hai kwke wo choose file blah blah likha aata hai but btn pr click kroge to wo uskw click ko trigger krde ga.  */}
